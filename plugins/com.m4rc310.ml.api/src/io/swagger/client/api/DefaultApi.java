...
import io.swagger.client.model.mls.AttributesForCategoryResponse;
import io.swagger.client.model.mls.Balance;
import io.swagger.client.model.mls.CategoriesResponse;
import io.swagger.client.model.mls.MStatus;
...
public class DefaultApi {
	...
	public Balance getBalance(int userId, String accessToken) throws ApiException {
		Object localVarPostBody = null;

		String localVarPath = String.format("/users/%d/mercadopago_account/balance", userId);
	...
	public String removeAppPermission(int userId, String accessToken) throws ApiException{
		Object localVarPostBody = null;

		String localVarPath = String.format("/users/%d/applications/%d", 
				userId, clientId);
	...
	public CategoriesResponse getCategoryPredictors(String productTitle) throws ApiException{
		Object localVarPostBody = null;

		String localVarPath = String.format("/sites/MLB/category_predictor/predict");
		...
		localVarQueryParams.addAll(apiClient.parameterToPairs("", "title", productTitle));
		...
		GenericType<CategoriesResponse> localVarReturnType = new GenericType<CategoriesResponse>() {
		};
		return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams,
				localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
	...
	public AttributesForCategoryResponse[] listAttributesForCategory(String categoryId) throws ApiException {
		Object localVarPostBody = null;
		String localVarPath = String.format("/categories/%s/attributes", categoryId);
...
//		localVarQueryParams.addAll(apiClient.parameterToPairs("", "title", productTitle));
		...
		GenericType<AttributesForCategoryResponse[]> localVarReturnType = new GenericType<AttributesForCategoryResponse[]>() {
		};
		return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams,
				localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
	}
	...
	public String createTestUser(String accessToken) throws ApiException {
		try {

			JSONObject json = new JSONObject();
			json.put("site_id", "MLB");

			String localVarPath = "/users/test_user";
			...
			return apiClient.invokeAPI(localVarPath, "POST", localVarQueryParams, json.toString(), localVarHeaderParams,
					localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
	...
	public ItemResponse changeItensStatus(String itemId, MStatus status, String accessToken) throws ApiException {

		try {
			JSONObject json = new JSONObject();
			json.put("status", status.getStatus());

			assertNotNull(itemId, "Missing the required parameter '{0}' when calling itemsPost", "itemId");
			assertNotNull(accessToken, "Missing the required parameter '{0}' when calling itemsPost", "accessToken");
			...
			return apiClient.invokeAPI(localVarPath, "PUT", localVarQueryParams, json.toString(), localVarHeaderParams,
					localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
	...
	private void assertNotNull(Object value, String messageError, Object... args) throws ApiException {
		if (value == null) {
			messageError = MessageFormat.format(messageError, args);
			throw new ApiException(400, messageError);
		}
	}
	 ...
	 * @param accessToken Go to
	 *                    http://developers.mercadolibre.com/products-authentication-authorization/
	 *                    to get a valid access_token for testing purposes.
	 *                    (required)
	 * @param body        (required)
	 * @return Object
	 * @throws ApiException if fails to make API call
	...
	public Object categoriesCategoryIdAttributesGet(String categoryId) throws ApiException {
		...
		if (categoryId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'categoryId' when calling categoriesCategoryIdAttributesGet");
		}

		// create path and map variables
		String localVarPath = "/categories/{category_id}/attributes".replaceAll("\\{" + "category_id" + "\\}",
	...
	public CategoryResponse categoriesCategoryIdGet(String categoryId) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/categories/{category_id}".replaceAll("\\{" + "category_id" + "\\}",
				apiClient.escapeString(categoryId.toString()));
	...
	public ItemResponse itemsItemIdGet(String itemId, String accessToken) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/items/{item_id}".replaceAll("\\{" + "item_id" + "\\}",
	...
	public Message messagesMessageIdGet(String accessToken, String messageId) throws ApiException {
		...
		if (accessToken == null) {
			throw new ApiException(400,
					"Missing the required parameter 'accessToken' when calling messagesMessageIdGet");
		}
		...
		// create path and map variables
		String localVarPath = "/messages/{message_id}".replaceAll("\\{" + "message_id" + "\\}",
	...
	public MessageSearchResults messagesOrdersOrderIdGet(String accessToken, Integer orderId) throws ApiException {
		...
		if (accessToken == null) {
			throw new ApiException(400,
					"Missing the required parameter 'accessToken' when calling messagesOrdersOrderIdGet");
		}

		// verify the required parameter 'orderId' is set
		if (orderId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'orderId' when calling messagesOrdersOrderIdGet");
		}

		// create path and map variables
		String localVarPath = "/messages/orders/{order_id}".replaceAll("\\{" + "order_id" + "\\}",
	...
	public Object ordersOrderIdGet(String accessToken, Integer orderId) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/orders/{order_id}".replaceAll("\\{" + "order_id" + "\\}",
				apiClient.escapeString(orderId.toString()));
	 ...
	 * @param offset      The number of results to skip before starting to collect
	 *                    the result set. (optional, default to 0)
	 * @param limit       The numbers of restuls to return. (optional, default to
	 *                    50)
	 * @return Object
	 * @throws ApiException if fails to make API call
	 */
	public Object ordersSearchGet(String accessToken, Integer buyer, Integer seller, Integer offset, Integer limit)
			throws ApiException {
		Object localVarPostBody = null;
	...
	public Shipment shipmentsShipmentIdGet(String accessToken, Long shipmentId) throws ApiException {
		...
		if (accessToken == null) {
			throw new ApiException(400,
					"Missing the required parameter 'accessToken' when calling shipmentsShipmentIdGet");
		}

		// verify the required parameter 'shipmentId' is set
		if (shipmentId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'shipmentId' when calling shipmentsShipmentIdGet");
		}

		// create path and map variables
		String localVarPath = "/shipments/{shipment_id}".replaceAll("\\{" + "shipment_id" + "\\}",
				apiClient.escapeString(shipmentId.toString()));
	...
	public CategoryPrediction sitesSiteIdCategoryPredictorPredictGet(String siteId, String title) throws ApiException {
		...
		if (siteId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'siteId' when calling sitesSiteIdCategoryPredictorPredictGet");
		}

		// verify the required parameter 'title' is set
		if (title == null) {
			throw new ApiException(400,
					"Missing the required parameter 'title' when calling sitesSiteIdCategoryPredictorPredictGet");
		}

		// create path and map variables
		String localVarPath = "/sites/{site_id}/category_predictor/predict".replaceAll("\\{" + "site_id" + "\\}",
				apiClient.escapeString(siteId.toString()));
	...
	public Site sitesSiteIdGet(String siteId) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/sites/{site_id}".replaceAll("\\{" + "site_id" + "\\}",
				apiClient.escapeString(siteId.toString()));
	...
	public UserResponse usersUserIdGet(Integer userId, String accessToken) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/users/{user_id}".replaceAll("\\{" + "user_id" + "\\}",
