 ...
 */
package com.m4rc310.ml.ui.streaming;
...
public class MStream {
    ...
    public static MStream getInstance() {
        return MStreamHolder.INSTANCE;
    }

    private static class MStreamHolder {

        private static final MStream INSTANCE = new MStream();
    }
}
